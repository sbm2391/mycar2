...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.getUser = function () {
        ...
        this.sessionService.loggedIn()
            .subscribe(function (user) {
            _this.user = user;
            _this.uploader.options.url = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].baseURL + ("api/user/" + _this.user._id + "/addimg");
        });
    };
